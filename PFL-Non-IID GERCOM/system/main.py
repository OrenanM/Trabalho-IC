...
if __name__ == "__main__":
    ...
    parser.add_argument('-wc', '--weigths_clients', type=int, default=1) #atribui pesos aos clientes
    ...
    with open(f"{args.algorithm}_metrics_{args.num_clusters}cluster_{args.type_select}_{args.num_clients}clients.txt", "w") as arquivo:
