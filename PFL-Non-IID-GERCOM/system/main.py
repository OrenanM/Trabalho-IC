...
if __name__ == "__main__":
    ...
    with open(f"{args.algorithm}_metrics_{args.entropy}_{args.weigths_clients}_{args.fall_tolerance}_exe.txt", "w") as arquivo:
        arquivo.write(f"t, round_converg, size, size_param\n")

    with open(f"{args.algorithm}_metrics_{args.entropy}_{args.weigths_clients}_{args.fall_tolerance}.txt", "w") as arquivo:
        arquivo.write(f"acc, loss, temp\n")
    
    with open(f"{args.algorithm}_metrics_{args.entropy}_{args.weigths_clients}_{args.fall_tolerance}_nnc.txt", "w") as arquivo:
        arquivo.write(f"acc, loss, temp\n")
